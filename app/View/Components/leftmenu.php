...
class leftmenu extends Component
{
    ...
    public function render(): View|Closure|string
    {
        ...
        $pages = [
            ...
            ['game.php?page=resources', 'lm_resources', '', '#ffffff', false, '1', '3'],
            ['game.php?page=resourceSettings', 'lm_resources_settings', '', '#ffffff', false, '1', '4'],
            ['game.php?page=station', 'lm_station', '', '#ffffff', false, '1', '3'],
            ...
            ['game.php?page=defense', 'lm_defenses', '', '#ffffff', false, '1', '12'],
