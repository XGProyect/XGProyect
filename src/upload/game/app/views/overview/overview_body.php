...
<div id="content">
    <table width="519">
        <tr>
            <td class="c" colspan="4"><a href="index.php?page=renameplanet" title="{Planet_menu}">{ov_planet} "{planet_name}"</a> ({user_name})</td>
        </tr>
        {Have_new_message}
        <tr>
        ...
        <tr>
            <th>{ov_position}</th>
            <th colspan="3"><a href="index.php?page=galaxy&mode=0&galaxy={galaxy_galaxy}&system={galaxy_system}">[{galaxy_galaxy}:{galaxy_system}:{galaxy_planet}]</a></th>
        </tr>
        <tr>
            <th>{ov_points}</th>
