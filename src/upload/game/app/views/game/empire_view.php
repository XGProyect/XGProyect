    ...
    <table border="0" cellpadding="0" cellspacing="1" width="750px">
        <tbody>
            ...
            <tr height="75px">
                ...
                {image}
                <th width="75px">
                    <a href="index.php?page=overview&cp={planet_id}&re=0">
            ...
            <tr height="20px">
                ...
                {coords}
                <th width="75px">
                    <a href="index.php?page=galaxy&mode=3&galaxy={planet_galaxy}&system={planet_system}">{planet_coords}</a>
                </th>
                {/coords}
            </tr>
            <tr height="20px">
            ...
            <tr>
                ...
                {metal_row}
                <th width="75px">
                    <a href="index.php?page=resources&cp={planet_id}&re=0&planettype={planet_type}">{planet_current_amount}</a> / {planet_production}
                </th>
                {/metal_row}
            </tr>
            <tr>
