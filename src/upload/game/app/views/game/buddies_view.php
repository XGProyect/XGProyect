...
<div id="content">
    <table width="520">
        ...
        <tr>
            <th>
                <a href="index.php?page=chat&playerId={id}">{username}</a>
            </th>
            <th>
                <a href="index.php?page=alliance&mode=ainfo&allyid={ally_id}">{alliance_name}</a>
            </th>
            <th>
                <a href="index.php?page=galaxy&mode=3&galaxy={galaxy}&system={system}">{galaxy}:{system}:{planet}</a>
            </th>
            <th>
                {text}
            </th>
