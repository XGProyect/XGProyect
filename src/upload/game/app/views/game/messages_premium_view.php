                    ...
                    <td>
                        <table width="519">
                            <tbody>
                                ...
                                <form action="index.php?page=messages" method="POST">
                                    <tr height="20"> </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th colspan="4">
                                            {user_name} <a href="index.php?page=chat&playerId={user_id}"><img src="{dpath}/img/m.gif" /></a>
                                        </th>
                                    </tr>
                                    {/buddy_list}
                                    <tr>
                                ...
                                <form action="index.php?page=messages" method="POST">
                                    ...
                                    <tr>
                                        <th colspan="4">
                                            <a href="#" onclick="f('index.php?page=notes&a=2&n={note_id}', 'Notes')">
