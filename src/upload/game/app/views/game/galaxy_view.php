...
<div id="content">
    ...
    <script type="text/javascript">
        ...
        function doit(order, galaxy, system, planet, planettype, shipcount) {
            ...
            ajax.requestFile = "index.php?page=galaxy&fleet=true&action=send";
    ...
    <table width="656px">
        <tr>
            <td class="c" colspan="8">
                <form action="index.php?page=galaxy&mode=1" method="post" id="galaxy_form" style="margin:0">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td style="background-color: transparent; width: 50%; text-align: right;">
                                <a href="index.php?page=fleet1&amp;galaxy={selected_galaxy}&amp;system={selected_system}&amp;planet=16&amp;planettype=1&amp;target_mission=15">
