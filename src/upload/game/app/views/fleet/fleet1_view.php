...
<div id="content">
            ...
            <td colspan="9" class="c">
                <table border="0" width="100%">
                    <tr>
                        ...
                        <td style="background-color: transparent;" align="right"><a href="index.php?page=movement">{fl_fleets_movements}</a></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <form action="index.php?page=fleet2" method="POST">
        <table width="519" border="0" cellpadding="0" cellspacing="1">
            <tr height="20">
