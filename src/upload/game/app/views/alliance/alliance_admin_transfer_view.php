...
<div id="content">
    <table width="520px">
        ...
        <form action="index.php?page=alliance&mode=admin&edit=transfer" method="POST">
            <tr>
        ...
        <tr>
            <td class="c" colspan="3"><a href="index.php?page=alliance&mode=admin&edit=ally">{al_back}</a></td>
        </tr>
    </table>
</div>
