...
<div id="content">
    <table width="519px">
        ...
        <tr>
            <th colspan="2"><a href="index.php?page=alliance&mode=admin&edit=rights">{al_manage_ranks}</a></th>
        </tr>
        <tr>
            <th colspan="2"><a href="index.php?page=alliance&mode=admin&edit=members">{al_manage_members}</a></th>
        </tr>
        <tr>
            <th colspan="2">
                <a href="index.php?page=alliance&mode=admin&edit=tag">
                    <img src="{dpath}alliance/appwiz.gif" border="0" alt="{al_manage_change_tag}">
                </a>
                &nbsp;
                <a href="index.php?page=alliance&mode=admin&edit=name">
    ...
    <form action="" method="POST">
        ...
        <table width=519>
            ...
            <tr>
                <th><a href="index.php?page=alliance&mode=admin&edit=ally&t=1">{al_outside_text}</a></th>
                <th><a href="index.php?page=alliance&mode=admin&edit=ally&t=2">{al_inside_text}</a></th>
                <th><a href="index.php?page=alliance&mode=admin&edit=ally&t=3">{al_request_text}</a></th>
            </tr>
            <tr>
    ...
    <table width=519>
        ...
        <tr>
            <th><input type="button" onclick="javascript:location.href = 'index.php?page=alliance&mode=admin&edit=exit';" value="{al_continue}"/></th>
        </tr>
    </table>
    <table width=519>
        <tr>
        ...
        <tr>
            <th><input type="button" onclick="javascript:location.href = 'index.php?page=alliance&mode=admin&edit=transfer';" value="{al_continue}"/></th>
        </tr>
    </table>
</div>
