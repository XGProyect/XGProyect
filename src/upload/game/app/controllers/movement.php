...
class Movement extends BaseController
{
     ...
     * @var string
     */
    const REDIRECT_TARGET = 'index.php?page=movement';
    ...
    public function __construct()
    {
        ...
        // load languages
        parent::loadLang(['missions', 'ships', 'fleet']);
    ...
    private function buildActionsBlock(FleetEntity $fleet): string
    {
        ...
        if ($fleet->getFleetMess() == 0) {
            $actions = '<form action="index.php?page=movement&action=return" method="post">';
            ...
            if ($fleet->getFleetMission() == Missions::ATTACK) {
                ...
                $attributes = 'onClick="f(\'index.php?page=federationlayer&fleet=' . $fleet->getFleetId() . '\', \'\')"';
