...
class Empire extends BaseController
{
    ...
    public function __construct()
    {
        ...
        // load models
        parent::loadModel('empire');

        // load languages
        parent::loadLang(['global', 'constructions', 'defenses', 'technologies', 'ships', 'empire']);
    }
    ...
    private function setStructureData(array $planet, array $source, string $element, int $element_id): string
    {
        ...
        $url = 'index.php?page=' . $page . '&cp=' . $planet['planet_id'] . '&re=0&planettype=' . $planet['planet_type'];
