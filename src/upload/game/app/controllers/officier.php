...
class Officier extends BaseController
{
    ...
    private function runAction()
    {
        ...
        if (in_array($data['offi'], $this->objects->getObjectsList('officier')) && in_array($data['time'], ['week', 'month'])) {
            ...
            if ($this->isOfficierAccesible($data['offi'], $time)) {
                ...
                Functions::redirect('index.php?page=officier');
            }
        }
    }
    ...
    private function buildPage(): void
    {
        ...
        $page = [];
        $page['dpath'] = DPATH;
        $page['premium_pay_url'] = Functions::readConfig('premium_url') != '' ? Functions::readConfig('premium_url') : 'index.php?page=officier';
    ...
    private function setOfficier(int $item_id): array
    {
        ...
        $item_to_parse['link_month'] = "index.php?page=officier&offi=" . $item_id . "&time=month";
        $item_to_parse['link_week'] = "index.php?page=officier&offi=" . $item_id . "&time=week";
