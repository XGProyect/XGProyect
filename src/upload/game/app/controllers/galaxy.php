...
class Galaxy extends BaseController
{
    ...
    public function __construct()
    {
        ...
        // load models
        parent::loadModel('fleet');
        parent::loadModel('galaxy');
    ...
    private function buildPage(): void
    {
        ...
        if ($mode == 2 && $this->planet['defense_interplanetary_missile'] < 1) {
            die(Functions::message($this->langs->line('gl_no_missiles'), "index.php?page=galaxy&mode=0", 2));
        }
    ...
    private function sendMissiles()
    {
        ...
        if ($errors != 0) {
            Functions::message($error, "index.php?page=galaxy&mode=0&galaxy=" . $galaxy . "&system=" . $system, 3);
        }
        ...
        Functions::message("<b>" . $missiles_amount . "</b>" . $this->langs->line('gl_missiles_sended') . $DefenseLabel[$target], "index.php?page=overview", 3);
    }
