...
class TraderLayer extends BaseController
{
    ...
    Functions::message($this->langs['tr_only_positive_numbers'], "index.php?page=traderOverview", 1);
    } else {
    ...
    die(Functions::message($storage, 'index.php?page=traderOverview', '2'));
    }
    ...
    Functions::message($this->langs['tr_not_enought_metal'], "index.php?page=traderOverview", 1);
    }
    }
    break;
    ...
    Functions::message($this->langs['tr_not_enought_crystal'], "index.php?page=traderOverview", 1);
    }
    }
    break;
    ...
    Functions::message($this->langs['tr_not_enought_deuterium'], "index.php?page=traderOverview", 1);
    }
    }
    break;
    }

    Functions::message($this->langs['tr_exchange_done'], "index.php?page=traderOverview", 1);
    } else {
