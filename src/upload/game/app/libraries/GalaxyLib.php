...
class GalaxyLib extends XGPCore
{
    ...
    private function planetNameBlock()
    {
        ...
        if ($this->row_data['planet_destroyed'] == 0) {
            if ($this->isPhalanxActive()) {
                $attributes = "onclick=fenster('index.php?page=phalanx&galaxy=" . $this->galaxy .
    ...
    private function usernameBlock()
    {
        ...
        $actions .= str_replace('"', '', UrlHelper::setUrl(
            'index.php?page=chat&playerId=' . $this->row_data['user_id'],
            $this->langs->line('write_message')
        ));
        $actions .= "</td></tr><tr><td>";
        $actions .= str_replace('"', '', UrlHelper::setUrl(
            "index.php?page=buddies&mode=2&u=" . $this->row_data['user_id'],
    ...
    private function actionsBlock(): string
    {
        ...
        $actions = [
            ...
            'write' => [
                ...
                'url' => 'index.php?page=chat&playerId=' . $this->row_data['user_id'],
            ],
            'buddy' => [
                'image' => Functions::setImage(DPATH . 'img/b.gif', $this->langs->line('gl_buddy_request')),
                'url' => 'index.php?page=buddies&mode=2&u=' . $this->row_data['user_id'],
            ],
            'missile' => [
                'image' => Functions::setImage(DPATH . 'img/r.gif', $this->langs->line('gl_missile_attack')),
                'url' => 'index.php?page=galaxy&mode=2&galaxy=' . $this->galaxy . '&system=' . $this->system . '&planet=' . $this->planet . '&current=' . $this->current_user['user_current_planet'],
            ],
        ];
    ...
    {
        $url = "index.php?page=fleet1&galaxy=" . $this->galaxy . "&amp;system=" . $this->system . "&amp;planet=" .
    ...
    {
        $url = "index.php?page=fleet1&galaxy=" . $this->galaxy . "&system=" . $this->system .
    ...
    {
        $url = "index.php?page=galaxy&mode=2&galaxy=" . $this->galaxy . "&system=" . $this->system . "&planet=" .
    ...
    {
        $attributes = "onclick=fenster(&#039;index.php?page=phalanx&galaxy=" . $this->galaxy . "&amp;system=" .
