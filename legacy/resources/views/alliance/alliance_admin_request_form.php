...
<form action="game.php?page=alliance&mode=admin&edit=requests&show={id}&sort=0" method="POST" role="form">
    ...
    <tr>
        <th scope="row">{al_reason} <span id="cntChars">0</span> / 500 {al_characters}</th>
        <th role="cell"><textarea name="text" cols="40" rows="10" onkeyup="javascript:cntchar(500)"></textarea></th>
    </tr>
    <tr>
