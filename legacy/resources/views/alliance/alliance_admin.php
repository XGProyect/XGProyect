...
<div id="content" role="main">
    <table role="presentation" width="519px">
        <tr>
            <td role="heading" aria-level="2" class="c" colspan="2">{al_manage_alliance}</td>
        </tr>
        <tr>
    ...
    <form action="" method="POST" role="form">
        ...
        <table role="presentation" width="519">
            <tr>
                <td role="heading" aria-level="2" class="c" colspan="3">{al_texts}</td>
            </tr>
            <tr>
    ...
    <form action="" method="POST" role="form">
        <table width=519>
            ...
            <tr>
                <th scope="row">{al_manage_founder_rank}</th>
                <th role="cell"><input type="text" name="owner_range" value="{alliance_owner_range}" size=30></th>
            </tr>
            <tr>
                <th scope="row">{al_manage_newcomer_rank}</th>
                <th role="cell"><input type="text" name="newcomer_range" value="{alliance_newcomer_range}" size=30></th>
            </tr>
            <tr>
                <th role="cell" colspan="2"><input type="submit" name="options" value="{al_save}"></th>
            </tr>
        </table>
    </form>
    <table width="519" role="presentation">
        <tr>
            <td role="heading" aria-level="2" class="c">{al_disolve_alliance}</td>
        </tr>
        <tr>
    ...
    <table width="519">
        <tr>
            <td role="heading" aria-level="2" class="c">{al_transfer_alliance}</td>
        </tr>
        <tr>
