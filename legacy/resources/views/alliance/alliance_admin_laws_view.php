...
<div id="content" role="main">
    ...
    <table width="519"><tr><td class="c" colspan="11">{al_configure_ranks}</td></tr>
        <form action="game.php?page=alliance&mode=admin&edit=rights" method="POST" role="form">
            ...
            {list_of_ranks}
            <tr>
                <th role="cell">{rank_delete}</th>
                <th scope="row">{rank_name}</th>
                <input type="hidden" name="id[]" value="{rank_id}">
                <th role="cell"><input type="checkbox" name="u{rank_id}r3" {checked_r3}{edit_check}></th>
                <th role="cell"><input type="checkbox" name="u{rank_id}r5" {checked_r5}{edit_check}></th>
                <th role="cell"><input type="checkbox" name="u{rank_id}r4" {checked_r4}{edit_check}></th>
                <th role="cell"><input type="checkbox" name="u{rank_id}r2" {checked_r2}{edit_check}></th>
                <th role="cell"><input type="checkbox" name="u{rank_id}r7" {checked_r7}{edit_check}></th>
                <th role="cell"><input type="checkbox" name="u{rank_id}r8" {checked_r8}{edit_check}></th>
                <th role="cell">{r1}</th>
                <th role="cell"><input type="checkbox" name="u{rank_id}r6" {checked_r6}{edit_check}></th>
                <th role="cell"><input type="checkbox" name="u{rank_id}r9" {checked_r9}{edit_check}></th>
            </tr>
            {/list_of_ranks}
            <tr>
                <th role="cell" colspan="11"><span style="float:rigth!important;"><input type="submit" value="{al_save}"></span></th>
            </tr>
            <tr>
    ...
    <form action="game.php?page=alliance&mode=admin&edit=rights" method="POST" role="form">
        <table width="519">
            ...
            <tr>
                <th scope="row">{al_rank_name}</th>
                <th role="cell"><input type="text" name="newrangname" size="20" maxlength="30"></th>
            </tr>
            <tr>
                <th role="cell" colspan="2"><input type="submit" name="create" value="{al_create}"></th>
            </tr>
        </table>
    </form>
    <form action="game.php?page=alliance&mode=admin&edit=rights" method="POST" role="form">
