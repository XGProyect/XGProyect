                                            ...
                                            <div class="collapse" id="toggle{changelog_id}">
                                                <div class="card shadow mb-4">
                                                    <div
                                                        ...
                                                        <h6 class="m-0 font-weight-bold text-primary">{{ __('admin/changelog.ch_the_description') }}
                                                        </h6>
                                                        <div class="dropdown no-arrow">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="admin.php?page=changelog&action=edit&changelogId={changelog_id}">{{ __('admin/changelog.ch_edit_this') }}</a>
                                                                <a class="dropdown-item"
                                                                    href="admin.php?page=changelog&action=delete&changelogId={changelog_id}">{{ __('admin/changelog.ch_delete_this') }}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- Card Body -->
